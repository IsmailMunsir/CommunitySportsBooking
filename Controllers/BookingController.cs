...
namespace CommunitySportsBooking.Controllers
{
    ...
    public class BookingController : Controller
    {
        ...
        private string CurrentMemberId => User.FindFirstValue(ClaimTypes.NameIdentifier)!;
        private string CurrentMemberName => User.FindFirstValue(ClaimTypes.Name)!;

        [HttpGet]
        public async Task<IActionResult> Create(string facilityId)
        {
