...
namespace CommunitySportsBooking.Controllers
{
    ...
    public class GuestController : Controller
    {
        ...
        // GET: /Guest/BecomeMember
        [HttpGet]
        public IActionResult BecomeMember() => View(new BecomeMemberViewModel());

        // POST: /Guest/BecomeMember — quick sign-up with basic info only.
        [HttpPost]
        ...
        // GET: /Guest/Search — restricted search: broad browsing, no full booking details.
        [HttpGet]
